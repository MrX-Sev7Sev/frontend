...
export default function MainPage() {
  ...
  const [articles] = useState([
    ...
    },
    {
      ...
      link: '/articles/alias',
      rules: 'Игроки объясняют слова, не называя их.',
      goal: 'Объяснить как можно больше слов за время.',
      tasks: 'Использовать синонимы и ассоциации.'
    },
    {
      id: 15,
      title: 'Угадай, Кто?',
      ...
      rules: 'Игроки задают вопросы, чтобы угадать персонажа соперника.',
      goal: 'Угадать персонажа соперника.',
      tasks: 'Задавать правильные вопросы.'
    },
    {
      id: 16,
      title: 'Имаджинариум',
      ...
      rules: 'Игроки придумывают ассоциации к картинкам.',
      goal: 'Набрать наибольщее количество очков.',
      tasks: 'Угадывать ассоциации других игроков.'
    },
    {
      id: 17,
      title: 'Свинтус',
      ...
      rules: 'Игроки избавляются от карт, выполняя задания.',
      goal: 'Первым избавиться от всех карт.',
      tasks: 'Использовать спецкарты и мешать соперникам.'
    },
    {
      id: 18,
      title: 'Крокодил',
      ...
      rules: 'Игроки показывают слова без слов.',
      goal: 'Правильно угадать слово.',
      tasks: 'Использовать жесты и мимику.'
    }
  ]);
