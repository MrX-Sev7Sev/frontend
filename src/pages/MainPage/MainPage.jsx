  ...
  const [articles] = useState([
    {
      ...
      rules: 'Игра в Uno проходит с использованием специальной колоды из 108 карт, состоящей из карт четырёх цветов (красный, зелёный, синий и жёлтый), а также специальных карт, таких как "Пропусти ход", "Обменяйся" и "Возьми две". Каждый игрок получает по 7 карт, а оставшиеся карты помещаются в центр стола, образуя стопку для сброса. Игроки по очереди выкладывают карты на стопку, следуя правилам: карта, которую они выкладывают, должна совпадать по цвету или номеру с верхней картой стопки. Если игрок не может сделать ход, он берёт карту из колоды. Если эта карта подходит, он может сразу её выложить.',
      tasks: [
        'Соблюдение правил: Игроки должны внимательно следить за правилами и следовать им, чтобы избежать недоразумений и споров.',
        'Стратегическое мышление: Игроки должны разрабатывать стратегии, чтобы блокировать ходы соперников и максимально эффективно использовать свои карты.',
        'Коммуникация: Взаимодействие с другими игроками может быть ключевым моментом, особенно когда речь идет о специальных картах, которые могут изменить ход игры.',
        'Увлечение процессом: Главное — получать удовольствие от игры, наслаждаясь временем, проведённым с друзьями и семьёй.'
      ],
    ...
    },
    {
      ...
      `,
      rules: `
        Правила игры зависят от конкретной вариации, но в большинстве случаев основа остаётся схожей. Игроки получают определённое количество карт, и цель игры заключается в том, чтобы использовать свои карты для выполнения заданий или достижения определённых условий. Например, в "Дураке" игроки по очереди сбрасывают карты, пытаясь избавиться от всех своих карт, в то время как в "Мафии" игроки делятся на команды и пытаются выявить друг друга.
      `,
      tasks: [
        'Стратегическое планирование: Игроки должны разрабатывать стратегии, чтобы эффективно использовать свои карты и предугадывать ходы соперников.',
        'Командная работа: В играх с командным взаимодействием важно сотрудничать с партнёрами, чтобы достичь общей цели.',
        'Анализ ситуации: Игроки должны уметь быстро оценивать ситуацию на игровом поле и принимать решения на основе текущих обстоятельств.',
        'Развлечение и общение: "Карты" — это не только игра, но и способ провести время с друзьями, общаясь и наслаждаясь процессом.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      rules: `
        Шахматы играются на квадратной доске размером 8x8 клеток, где каждый игрок начинает с 16 фигур: одной королевы, одного короля, двух слонов, двух коней, двух ладей и восьми пешек. Цель игры — поставить мат королю противника, что означает, что король не может избежать захвата. Игроки по очереди делают ходы, перемещая свои фигуры согласно установленным правилам. Каждая фигура имеет свои уникальные способы передвижения: например, слоны движутся по диагоналям, а ладьи — по вертикалям и горизонталям.
      `,
      tasks: [
        'Стратегическое мышление: Игроки должны разрабатывать долгосрочные стратегии, предугадывая ходы соперника и планируя свои действия.',
        'Тактические комбинации: Важно уметь находить тактические возможности, такие как шахи, двойные атаки и ловушки.',
        'Контроль центра: Занятие центральных клеток доски даёт игроку больше возможностей для маневра и контроля над игрой.',
        'Анализ и оценка позиций: Игроки должны уметь оценивать позиции на доске, определять сильные и слабые стороны своих и противниковых фигур.'
      ],
      description: `
    ...
    },
    {
      ...
      goal: `
        Цель игры в шашки — уничтожить все шашки противника или заблокировать их так, чтобы противник не мог сделать ход. Игра может закончиться также ничьей, если ни одна из сторон не может выиграть.
      `,
      rules: `
      ...
      `,
      tasks: [
        'Стратегическое планирование: Игроки должны разрабатывать стратегии, чтобы эффективно использовать свои шашки и предугадывать ходы соперника.',
        'Тактические комбинации: Важно находить возможности для захвата шашек противника и создавать угрозы, которые заставят его делать невыгодные ходы.',
        'Контроль центра: Занятие центральных клеток доски даёт игроку больше возможностей для маневра и контроля над игрой.',
        'Анализ позиций: Игроки должны уметь оценивать позиции на доске, определять сильные и слабые стороны своих шашек и противника.'
      ],
      description: `
        Шашки — это классическая настольная игра, которая известна во многих странах и имеет множество вариаций. Игра сочетает в себе простоту правил и стратегическую глубину, что делает её доступной для игроков всех возрастов. Шашки развивают логическое мышление, внимание и умение планировать свои действия.
      `
    },
    {
      id: 5,
      ...
      `,
      tasks: [
        'Стратегическое планирование: Игроки должны разрабатывать стратегии для перемещения своих фишек, учитывая как свои, так и противниковые ходы.',
        'Управление рисками: Игроки должны оценивать риски, связанные с захватом фишек противника и возможностью быть захваченными сами.',
        'Контроль позиций: Важно контролировать ключевые пункты на доске, чтобы ограничить движения противника и создать выгодные условия для себя.',
        'Анализ ситуации: Игроки должны уметь быстро оценивать текущую ситуацию на доске и принимать решения на основе броска кубиков и позиций фишек.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      tasks: [
        'Дедукция и анализ: Игроки должны уметь анализировать поведение других участников, чтобы выявить мафию.',
        'Коммуникация: Важно уметь убеждать других игроков в своей правоте и строить альянсы, чтобы достичь своей цели.',
        'Стратегическое планирование: Игроки должны разрабатывать стратегии, как для мафии, так и для мирных жителей, чтобы максимально эффективно использовать свои роли.',
        'Психологическая игра: Умение читать эмоции и реакции других игроков может стать ключевым фактором в определении их ролей.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      tasks: [
        'Стратегическое планирование: Игроки должны разрабатывать стратегии для покупки и развития недвижимости, чтобы максимизировать свои доходы.',
        'Торговля: Умение вести переговоры и торговаться с другими игроками может стать ключевым фактором в достижении успеха.',
        'Управление финансами: Игроки должны следить за своими доходами и расходами, чтобы избежать банкротства.',
        'Анализ рисков: Игроки должны оценивать риски, связанные с покупкой участков и строительством, а также учитывать возможные последствия бросков кубиков.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      tasks: [
        'Ловкость и координация: Игроки должны аккуратно извлекать блоки, чтобы не нарушить баланс башни.',
        'Стратегическое мышление: Игроки должны оценивать, какие блоки легче всего извлечь, не ставя под угрозу устойчивость всей конструкции.',
        'Терпение: Важно сохранять спокойствие и не спешить, чтобы избежать ошибок, которые могут привести к падению башни.',
        'Анализ ситуации: Игроки должны уметь быстро оценивать текущее состояние башни и принимать решения на основе её устойчивости.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      tasks: [
        'Создание персонажа: Игроки должны разрабатывать уникальных персонажей с интересными предысториями и мотивациями.',
        'Командная работа: Успех в D&D часто зависит от сотрудничества между игроками, которые должны использовать свои навыки и способности для достижения общих целей.',
        'Ролевое взаимодействие: Игроки должны активно участвовать в ролевом взаимодействии, принимая на себя роли своих персонажей и взаимодействуя с миром, созданным DM.',
        'Стратегическое мышление: Игроки должны разрабатывать стратегии для боя, исследования и решения головоломок, учитывая сильные и слабые стороны своих персонажей.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      tasks: [
        'Стратегическое планирование: Игроки должны разрабатывать стратегии для размещения тайлов и фишек, чтобы создать выгодные комбинации и заработать очки.',
        'Анализ ситуации: Важно оценивать текущую игровую ситуацию и предугадывать ходы соперников, чтобы блокировать их возможности.',
        'Управление ресурсами: Игроки должны эффективно использовать свои мииплы, так как их количество ограничено, и важно выбирать, где их разместить для максимальной выгоды.',
        'Гибкость: Игроки должны быть готовы адаптироваться к изменениям на игровом поле и использовать новые возможности, которые появляются в ходе игры.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      tasks: [
        'Аргументация: Игроки должны убедительно доказывать свою полезность, используя свои характеристики и навыки.',
        'Дедукция: Важно анализировать характеристики других игроков и выявлять их слабые стороны.',
        'Коммуникация: Умение слушать, задавать вопросы и вести переговоры может стать ключом к успеху.',
        'Стратегия: Игроки должны разрабатывать стратегии, чтобы защитить себя и убедить других в своей ценности.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      tasks: [
        'Командная работа: Игроки должны эффективно сотрудничать, делясь информацией и ресурсами, чтобы достичь общей цели.',
        'Стратегическое планирование: Важно разрабатывать стратегии для перемещения по карте, лечения болезней и строительства станций, чтобы минимизировать угрозу.',
        'Анализ ситуации: Игроки должны постоянно оценивать текущую ситуаона игровом поле и принимать решения на основе изменений в распространении болезней.',
        'Управление ресурсами: Игроки должны эффективно использовать свои карты и действия, чтобы максимизировать шансы на победу.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      tasks: [
        'Словарный запас: Игроки должны использовать свои знания языка, чтобы составлять слова и находить наилучшие комбинации.',
        'Стратегическое планирование: Важно разрабатывать стратегии для размещения слов, чтобы максимизировать очки и блокировать возможности соперников.',
        'Анализ ситуации: Игроки должны оценивать текущее состояние игрового поля и принимать решения на основе доступных букв и позиций.',
        'Креативность: Игроки могут проявлять креативность, находя необычные слова и комбинации, которые могут принести дополнительные очки.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      tasks: [
        'Командная работа: Игроки должны эффективно сотрудничать, чтобы угадывать слова, основываясь на объяснениях своего товарища по команде.',
        'Креативность: Умение находить оригинальные и интересные способы объяснения слов может значительно повысить шансы на успех.',
        'Быстрота реакции: Игроки должны быстро реагировать и принимать решения, чтобы успеть угадать как можно больше слов за отведённое время.',
        'Анализ ассоциаций: Игроки должны уметь делать ассоциации и находить связи между словами, чтобы облегчить процесс объяснения и угадывания.'
      ],
      description: `
    ...
    },
    {
      id: 15,
      title: 'Угадай, Кто?',
      image: '/assets/articles/guess_who.jpg',
      link: '/articles/guess_who',
      goal: `
        Цель игры в Угадай, Кто? — первым угадать, кто ты, задавая правильные вопросы и используя логику для исключения неверных вариантов. Игроки должны стремиться к тому, чтобы максимально эффективно использовать свои вопросы для достижения успеха.
      `,
      rules: `
        В Угадай, Кто? каждый игрок получает карточку с изображением персонажа, которую он прикрепляет к своему лбу так, чтобы другие игроки могли видеть, кто это, но сам игрок не знает. Цель игры — угадать, кто ты, задавая вопросы, на которые другие игроки могут ответить только "Да" или "Нет". Вопросы могут касаться внешности персонажа, его профессии, возраста и других характеристик.<br/><br/>
        Игроки по очереди задают вопросы, и на основе ответов они должны сужать круг возможных персонажей. Игра продолжается до тех пор, пока один из игроки не угадает своего персонажа или пока не будут исчерпаны все возможности.
      `,
      tasks: [
        'Логическое мышление: Игроки должны анализировать ответы на свои вопросы и делать выводы о том, кто может быть их персонажем.',
        'Коммуникация: Важно уметь формулировать вопросы так, чтобы получить полезную информацию для дальнейших догадок.',
        'Стратегическое планирование: Игроки должны разрабатывать стратегии для выбора вопросов, которые помогут быстрее сузить круг возможных персонажей.',
        'Внимание к деталям: Игроки должны обращать внимание на характеристики персонажей, чтобы не упустить важные подсказки.'
      ],
      description: `
        Угадай, Кто? — это увлекательная настольная игра, основанная на задавании вопросов и дедукции, которая идеально подходит для семейных вечеров и дружеских встреч. Игра развивает навыки логического мышления, общения и способности к анализу. Угадай, Кто? позволяет игрокам погрузиться в мир весёлых догадок и неожиданных открытий.
      `
    },
    {
      id: 16,
      ...
      `,
      tasks: [
        'Креативность: Игроки должны проявлять воображение, создавая оригинальные подсказки и ассоциации.',
        'Коммуникация: Важно уметь передавать свои мысли и идеи другим игрокам, чтобы они могли правильно интерпретировать подсказки.',
        'Анализ ситуации: Игроки должны оценивать, какие карты могут быть выбраны другими игроками, и делать выводы на основе предыдущих раундов.',
        'Внимание к деталям: Игроки должны обращать внимание на изображения на картах, чтобы находить неожиданные связи и ассоциации.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      rules: `
        В Свинтус игроки получают карты, на которых изображены свиньи и различные действия. Цель игры — первым избавиться от всех своих карт. Игроки по очереди делают ходы, выкладывая карты на стол. Каждая карта может иметь свои уникальные действия, такие как "поменяйся картами", "пропусти ход" или "возьми дополнительные карты". Игроки могут также использовать специальные карты, чтобы усложнить игру для соперников или облегчить свои ходы.<br/><br/>
      ...
      `,
      tasks: [
        'Стратегическое планирование: Игроки должны разрабатывать стратегии для использования своих карт, чтобы максимально эффективно избавиться от них.',
        'Анализ ситуации: Важно оценивать текущую игровую ситуацию и предугадывать ходы соперников, чтобы блокировать их возможности.',
        'Коммуникация: Игроки могут взаимодействовать друг с другом, используя карты, которые влияют на ход игры, что требует умения вести переговоры и договариваться.',
        'Гибкость: Игроки должны быть готовы адаптироваться к изменениям в игре и использовать неожиданные возможности, которые могут возникнуть.'
      ],
      description: `
    ...
    },
    {
      ...
      `,
      rules: `
        В Крокодиле игроки делятся на команды, и в каждом раунде один из игроков выбирает слово или фразу, которую он должен объяснить своей команде, не используя слов. Вместо этого игрок использует жесты, мимику и движения, чтобы донести смысл слова. Остальные члены команды должны угадать, что именно изображает игрок.<br/><br/>
      ...
      `,
      tasks: [
        'Командная работа: Игроки должны эффективно сотрудничать, чтобы угадывать слова, основываясь на объяснениях своего товарица по команде.',
        'Креативность: Умение находить оригинальные и интересные способы объяснения слов может значительно повысить шансы на успех.',
        'Быстрота реакции: Игроки должны быстро реагировать и принимать решения, чтобы успеть угадать как можно больше слов за отведённое время.',
        'Анализ ассоциаций: Игроки должны уметь делать ассоциации и находить связи между словами, чтобы облегчить процесс объяснения и угадывания.'
      ],
